					...
					<?php foreach ($products as $product ): ?>
						<div class="col-md-6 bottom-cd simpleCart_shelfItem">
							<div class="product-at ">
								<a href="editar.php?id=<?php echo $product['id']; ?>"><img class="img-responsive" src="<?php echo RUTA; ?>/images/<?php echo $product['imagen'];?>" alt="">
								<div class="pro-grid">
											<span class="buy-in">Editar</span>
								</div>
							</a>	
							</div>
							<p class="tun"><span><?php echo  $product['nombre'];?></span><br><?php echo  $product['descripcion'];?></p>
							<div class="ca-rt">
